...
print("Model = %s" % (end - start))
write_list(['Model', n_int_ABC, c, end - start], '../results/bench_{}_{}'.format(n_int_ABC, c))
...
# pd.DataFrame({'E':E,'H':H}).to_csv('../results/dat_{}.csv'.format(seed))
...
# write_list([-1, t_1, t_2, t_upper, N_AB, N_ABC, r, forward_loglik(transitions, emissions, starting, E)], '../results/sim_{}.txt'.format(seed))
...
#     N_init, N_init, 
#     r_init, mu_init, 
#     n_int_AB, n_int_ABC, E, '../results/sim_{}.txt'.format(seed), False
# )
